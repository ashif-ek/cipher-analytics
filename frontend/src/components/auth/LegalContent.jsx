  ...
  const content = {
    terms: (
      <div className="space-y-6 font-sans text-sm text-slate-600 leading-relaxed">
        <section>
          <h4 className="font-bold text-slate-900 mb-2 text-xs">1. Identity & Access</h4>
          <p>
        ...
        <section>
          <h4 className="font-bold text-slate-900 mb-2 text-xs">2. Industrial Standards</h4>
          <p>
        ...
        <section>
          <h4 className="font-bold text-slate-900 mb-2 text-xs">3. Data Integrity</h4>
          <p>
        ...
        <div className="pt-4 border-t border-slate-100 font-mono text-[10px]">
    ...
    privacy: (
      <div className="space-y-6 font-sans text-sm text-slate-600 leading-relaxed">
        <section>
          <h4 className="font-bold text-slate-900 mb-2 text-xs">1. Telemetry & Logs</h4>
          <p>
        ...
        <section>
          <h4 className="font-bold text-slate-900 mb-2 text-xs">2. Cryptographic Privacy</h4>
          <p>
        ...
        <section>
          <h4 className="font-bold text-slate-900 mb-2 text-xs">3. Policy Revisions</h4>
          <p>
