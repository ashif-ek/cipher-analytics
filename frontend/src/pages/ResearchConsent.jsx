  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 py-6">
      <div className="text-center space-y-4">
        <h1 className="text-3xl font-bold text-slate-900 tracking-wide">Research Authorization & Policy</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
        <Card className="p-8 border-slate-200 hover:border-slate-300 transition-colors">
          <div className="flex items-start space-x-6">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2">
                <span className="text-[10px] font-bold px-2 py-1 bg-emerald-50 text-emerald-600 rounded border border-emerald-100">Active Protection</span>
              </div>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-8 border-slate-200 hover:border-slate-300 transition-colors">
          <div className="flex items-start space-x-6">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-slate-900">Institutional Review</h3>
              <p className="text-xs text-slate-500 leading-relaxed font-medium">
                Requires explicit manual approval for any cross-domain data aggregation tasks.
              </p>
               <div className="pt-2">
                <span className="text-[10px] font-bold px-2 py-1 bg-slate-100 text-slate-500 rounded border border-slate-200">Optional Policy</span>
              </div>
            </div>
          </div>
        </Card>
      ...
      <Card className="border-slate-200 overflow-hidden mt-12">
        <div className="p-8 space-y-6">
           <h3 className="text-xs font-bold text-slate-900 mb-4">Governance Configuration</h3>
           <div className="divide-y divide-slate-100">
             <div className="py-4 flex items-center justify-between">
               <div>
                 <span className="block text-sm font-bold text-slate-900">Auto-Archive After Research</span>
             ...
             <div className="py-4 flex items-center justify-between">
               <div>
                 <span className="block text-sm font-bold text-slate-900">Public Metadata Disclosure</span>
