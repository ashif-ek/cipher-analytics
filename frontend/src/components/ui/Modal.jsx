      ...
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        ...
        <div className={`relative inline-block align-middle bg-white rounded-3xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 ${maxWidth} sm:w-full z-10 border border-slate-200/50`}>
          ...
          <div className="bg-slate-50/50 px-8 py-5 sm:flex sm:flex-row-reverse gap-3 border-t border-slate-100">
            <button
              type="button"
              className="w-full inline-flex justify-center rounded-xl px-6 py-2.5 text-[10px] font-bold focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all shadow-sm bg-slate-900 hover:bg-black text-white"
              onClick={onConfirm}
            >
              {confirmText}
            </button>
            <button
              type="button"
              className="mt-3 sm:mt-0 w-full inline-flex justify-center rounded-xl px-6 py-2.5 bg-white text-[10px] font-bold text-slate-500 hover:bg-slate-50 hover:text-slate-900 border border-slate-200 transition-all sm:w-auto"
              onClick={onClose}
            >
              Cancel
            </button>
