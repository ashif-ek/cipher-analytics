...
const StatusBadge = ({ status }) => {
  const statusConfig = {
    ...
    SHARED: { color: 'bg-blue-50 text-blue-600 border-blue-200', text: 'Shared', icon: null },
    COLLABORATIVE: { color: 'bg-purple-50 text-purple-600 border-purple-200', text: 'Collaborative', icon: null },
    PUBLIC: { color: 'bg-slate-900 text-white border-slate-900', text: 'Public', icon: null },
  };
