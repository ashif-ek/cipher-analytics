    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <Card className="p-8 border-slate-200 hover:border-slate-300 transition-colors">
          <dt className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Total Datasets</dt>
          <dd className="text-4xl font-black text-slate-900 tracking-tighter">{stats.total}</dd>
          <div className="mt-6 flex items-center text-[10px] text-slate-400 font-bold uppercase tracking-wider">
        ...
        <Card className="p-8 border-slate-200 hover:border-slate-300 transition-colors">
          <dt className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Internal Share</dt>
          <dd className="text-4xl font-black text-slate-900 tracking-tighter">{stats.shared} <span className="text-xs font-bold text-slate-400 tracking-normal uppercase ml-1">/ {stats.total}</span></dd>
          <div className="mt-6 flex items-center text-[10px] text-slate-400 font-bold uppercase tracking-wider">
            <svg className="h-4 w-4 mr-2 text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
            Cross-Unit Access
          </div>
        </Card>

        <Card className="p-8 border-slate-200 hover:border-slate-300 transition-colors">
          <dt className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Research Data</dt>
          <dd className="text-4xl font-black text-slate-900 tracking-tighter">{stats.researchReady}</dd>
          <div className="mt-6 flex items-center text-[10px] text-slate-400 font-bold uppercase tracking-wider">
            <svg className="h-4 w-4 mr-2 text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
            Analysis Capability
          </div>
        </Card>

        <Card className="p-8 border-slate-200 hover:border-slate-300 transition-colors">
          <dt className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Live Infrastructure</dt>
          <dd className="text-4xl font-black text-slate-900 tracking-tighter">{stats.liveSessions} <span className="text-xs font-bold text-slate-400 uppercase ml-1">Active</span></dd>
          <div className="mt-6 flex items-center text-[10px] text-slate-900 font-black uppercase tracking-widest">
